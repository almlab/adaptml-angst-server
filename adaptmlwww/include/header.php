...
/**
 * Read the entirety of a given file
 **/
function readFileContents($location){
...
<html lang="en-US">
    ...
    <link rel="stylesheet" type="text/css" href="include/adaptml.css" />
    <script src="../javascript/hover.js" language="JavaScript" type="text/javascript"></script>
    <script type="text/javascript" src="include/adaptml.js"></script>
    <script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.8.2/jquery.min.js"></script>
    <script type="text/javascript" src="include/wrapLikelihoodcall.js"></script>
    </head>
    <body>
